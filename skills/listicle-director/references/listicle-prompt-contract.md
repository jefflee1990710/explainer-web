...
4. Number device: repeat its spec (shape, colour, position) and the digits it shows in this clip; digits only, exactly as approved.
...
10. Negatives: no captions/subtitles/written item titles, no extra digits or wrong numbers, no host restyle, no style drift, no extra limbs, plus the Visual style negatives.
