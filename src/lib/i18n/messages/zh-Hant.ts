...
export const zhHant: Messages = {
  ...
  mcp: {
    ...
    keysTitle: "API keys",
    keysEmpty: "還沒有 API key。先建立一把再連客戶端。",
    createKey: "建立 key",
    revokeKey: "撤銷",
    keyOnce: "請立即複製這把 key — 之後不會再顯示。",
    keyCopied: "已複製",
    copyKey: "複製",
    lastUsed: "上次使用 {date}",
    neverUsed: "尚未使用",
    dashboardTitle: "用量（近 30 日）",
    calls30d: "{count} 次工具呼叫",
    credits30d: "經 MCP 消耗 {credits} credits",
    errorRate: "錯誤率 {rate}%",
    byTool: "依工具",
  ...
  affiliate: {
    title: "Affiliate",
    subtitle:
      "分享你的推薦碼或連結。被推薦用戶購買 credits 與消耗 credits 時，你都能拿佣金。",
    codeTitle: "你的推薦碼",
    copyCode: "複製推薦碼",
    copyLink: "複製連結",
    copied: "已複製",
    ...
    thisMonth: "本月 {amount}",
    ratesTitle: "三級佣金",
    rateBuy: "L{level} 購買 {pct}%",
    rateConsume: "L{level} 消耗 {pct}%",
    rateTotal: "三層疊加上限（買 + 消耗）：{pct}%",
    downlineTitle: "你的下線",
    downlineEmpty: "還沒有被推薦用戶。分享連結開始賺取佣金。",
    colUser: "用戶",
    colBought: "購買",
    colConsumed: "消耗",
    colEarned: "你的佣金",
    payoutTitle: "提領",
    payoutHint: "待結餘額達 $50 可申請提領。目前為人工打款。",
    payoutRequest: "申請提領",
